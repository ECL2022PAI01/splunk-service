...
if __name__=="__main__":
    sli= SplunkProvider(project='test',stage='qa',service='helloservice',labels={}, customQueries={'test_query' : '|inputcsv test.csv | stats count'}, host='20.74.2.83', token='eyJraWQiOiJzcGx1bmsuc2VjcmV0IiwiYWxnIjoiSFM1MTIiLCJ2ZXIiOiJ2MiIsInR0eXAiOiJzdGF0aWMifQ..iaTaiGxxxkLQ7n_zGocQh9q-3XGPwU45UMI5WancgFUJ8sEobDGITF5R-jRX1gl3gBLXPV3nDlsStRB2sDZr7g', port='8089').get_sli('test_query', '2023-04-03T04:40:03.880','2023-04-03T04:42:03.880')
    print(sli)
